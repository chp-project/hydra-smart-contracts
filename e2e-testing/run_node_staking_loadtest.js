...
const { creditAccounts, creditAccountsEth, checkBalances, approveAllowances, checkAllowances} = require('./lib/1_accounts_scaffolding');
const { stakeNodes, checkNodeStakings } = require('./lib/2_staking_actions');

const accounts = generateDonorWalletsBulk(5)
...
(async function() {
  ...
  let nodes = R.pipeP(
    ...
    tap(() => titleLogger('Transferring ETH'), creditAccountsNodesEth),
  ...
  console.log('\n' + chalk.magenta('Staking Nodes in parallel:'));
